Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, ENV['FACEBOOK_APP_ID'], ENV['FACEBOOK_APP_SECRET'], redirect_uri: "https://railsomniauth.onrender.com/auth/facebook/callback", client_id: ENV['FACEBOOK_APP_ID'], state: "facebook"
